	...
	if request.method=="POST":
		try:
			...
			if request.POST['password']==request.POST['cpassword']:
				...
				querystring = {"authorization":"DwF5Auzh16qo3fXC2JMSTcOiyBEZmWH0eR8GIg4NbQrpUnKsjvhz0YwyOCGvHJEFuXRrTc7feDVaM1NA","message":"Your OTP For SignUp Is : "+str(otp),"language":"english","route":"q","numbers":str(mobile)}
